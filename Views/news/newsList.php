...
<div class="nav">
	<ul class="nav__elem">
		...
		?>
		<li>
			<a href="/news/page-<?=$i?>/" class="nav__elem--button <?=($i == $currNewsList) ? 'nav__elem--button-flag' : ''?>">
				<?=$i?>
			</a>
		</li>
		<?php 
		...
		?>
		<li class="nav__elem--button-li"><a href="/news/page-<?=min($currNewsList + 1, $listsAmount)?>/"><div class="nav_elem--button--arrow" id="arrow-2"></div></a></li>
	</ul>
</div>